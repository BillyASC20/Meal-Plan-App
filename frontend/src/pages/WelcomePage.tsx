// WelcomePage: clean Apple-style welcome screen with scroll-driven hero and vertically
// stacked feature cards. Removed prior glass/orb design and emojis per user request.
...
export const WelcomePage = () => {
  ...
  // Hero scroll values (fade + slight lift) - phase out later and more gently
  ...
  // Cards: stacked vertically; increase scroll distance so transitions feel slower
  ...
  return (
    <div className="welcome-page">
      ...
      <div className="welcome-content" ref={containerRef}>
        ...
        {/* Vertically stacked, scroll-driven cards */}
      ...
      {/* Fixed bottom CTA for easy access (no hover/animation) */}
      <button
